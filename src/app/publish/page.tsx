  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0e14] text-zinc-900 dark:text-zinc-100">
      ...
      <section className="max-w-3xl mx-auto px-8 py-16">
        <h1 className="text-3xl font-bold mb-4">发布你的 Skill</h1>
        <p className="text-zinc-500 dark:text-zinc-400 mb-8">这个页面即将完善，你可以在这里发布新的 AI Agent Skill。</p>
        <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40 p-8 text-center">
          <p className="text-zinc-500">📦 发布表单正在开发中...</p>
          <a href="/" className="mt-4 inline-block text-blue-600 dark:text-blue-400 hover:underline">返回首页</a>
        </div>
      </section>
    </div>
  );
