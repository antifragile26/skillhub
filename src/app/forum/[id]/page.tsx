...
export default function PostDetailPage() {
  ...
  return <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100"><ForumHeader /><section className="mx-auto max-w-5xl px-5 py-8 sm:px-8"><Link href="/forum" className="text-sm font-medium text-blue-600 hover:text-blue-500">← 返回论坛</Link>
