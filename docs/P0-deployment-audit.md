...
| 公网旁路预览 | `https://deploy-preview-1--skillhub-1785163757.netlify.app/forum` | PR #1 的预览部署；四步浏览器验收通过，作为当前可体验链接，不代表 3015 已切换 |
...
| A05 | 部分完成 | 公网旁路列表显示 4 条预期帖子；3015 仍为空 |
| A06 | 部分完成 | 公网旁路真实 ID 3 详情 200 且标题/正文可见；3015 没有可确认详情 ID |
| A07 | 部分完成 | 公网旁路 `/forum/new` 200 且表单可见；3015 仍 404，未做登录发帖写入 |
